...
import io.scalacraft.core.packets.clientbound.PlayPackets.{ConfirmTransaction, SetSlot}
import io.scalacraft.core.packets.serverbound.PlayPackets.{ClickWindow, CloseWindow}
