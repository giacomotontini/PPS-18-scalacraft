...
object Entities {
  ...
  class SmallFireball extends AbstractFireball with MobEntity
  ...
  class Firework extends Entity with ObjectEntity {
    ...
    @indexType(index = 1)
    @boxed var entityIdOrEntityWhichUsedFirework: Int = 0
  }
  ...
  class Insentient extends Living {
    @indexType(index = 0)
    @byte var insentientStatus: Int = 0
  }
  ...
  class Llama extends ChestedHorse with MobEntity {
    @indexType(index = 1)
    @boxed var strength: Int = 0
    @indexType(index = 1)
    @boxed var carpetColor: Int = -1
    @indexType(index = 1)
    @boxed var variant: Int = 0
  }
  ...
  class Pig extends Animal with MobEntity {
    ...
    @indexType(index = 1)
    @boxed var timeToBoostWithCarrotOnAStrick: Int = 0
  ...
  class TameableAnimal extends Animal {
    @indexType(index = 0)
    @byte var tameableAnimalStatus: Int = 0
    @indexType(index = 12) var owner: Option[UUID] = None
  }
  ...
  class IronGolem extends Golem with MobEntity {
    @indexType(index = 0)
    @byte var ironGolemStatus: Int = 0
  }

  class Snowman extends Golem with MobEntity {
    @indexType(index = 0)
    @byte var snowmanStatus: Int = 0x10
  }
  ...
  class Shulker extends Golem with MobEntity with ObjectEntity {
    ...
    @indexType(index = 0)
    @byte var shieldHeight: Int = 0
    @indexType(index = 0)
    @byte var color: Int = 10
  }
  ...
  class Blaze extends Monster with MobEntity with ObjectEntity {
    @indexType(index = 0)
    @byte var blazeStatus: Int = 0
  }

  class Creeper extends Monster with MobEntity {
    @indexType(index = 1)
    @boxed var state: Int = -1
  ...
  class Wither extends Monster {
    @indexType(index = 1)
    @boxed var centerHeadTarget: Int = 0 //entity Id or 0 if no target
    @indexType(index = 1)
    @boxed var leftHeadTarget: Int = 0 //entity Id or 0 if no target
    @indexType(index = 1)
    @boxed var rightHeadTarget: Int = 0 //entity Id or 0 if no target
    @indexType(index = 1)
    @boxed var invulnerableTime: Int = 0
  }

  class Zombie extends Monster with MobEntity {
    @indexType(index = 7) var isBaby: Boolean = false
    @indexType(index = 1)
    @boxed var unused: Int = 0
  ...
  class Minecart extends Entity with ObjectEntity {
    @indexType(index = 1)
    @boxed var shakingPower: Int = 0
    @indexType(index = 1)
    @boxed var shakingDirection: Int = 1
    @indexType(index = 2) var shakingMultiplier: Float = 0.0f
    @indexType(index = 1)
    @boxed var customBlockIdAndDamage: Int = 0
    @indexType(index = 1)
    @boxed var customBlockYposition: Int = 6
